...
const { activeFilter, getFilteredProducts: items } = storeToRefs(productsStore);
...
function showMore() {
    productsStore.showMore();
}
function sortByRating() {
    productsStore.sortByRating();
}
function sortByPrice() {
    productsStore.sortByPrice();
}
function sortAll(){
    productsStore.sortAll();
}
function sortByType(type: string){
    productsStore.sortByType(type);
}
        ...
        .best-sales__header
            ...
            nav.best-sales__nav
                ul.best-sales__nav-list
                    ...
                    li.best-sales__nav-item
                        a.best-sales__nav-link(href="#" :class="{ active: activeFilter === 'drinks' }" @click.prevent="sortByType('drinks')") Drinks
                    li.best-sales__nav-item
                        a.best-sales__nav-link(href="#" :class="{ active: activeFilter === 'fruit' }" @click.prevent="sortByType('fruit')") Fruit
        .best-sales__grid
